...
export class PaverAttributes implements RoleAttributes {
    ...
    //Tiny Paver: 2 WORK / 2 CARRY / 2 MOVE Total Cost: 400 Energy for 6 total parts
    Tiny = [
        WORK, WORK,
        CARRY, CARRY,
        MOVE, MOVE
    ...
    //Small Paver: 4 WORK / 4 CARRY / 4 MOVE Total Cost: 800 Energy for 12 total parts
    Small = [
        WORK, WORK, WORK, WORK,
    ...
    //Medium Paver: 6 WORK / 8 CARRY / 6 MOVE Total Cost: 1300 Energy for 20 total parts
    Medium = [
