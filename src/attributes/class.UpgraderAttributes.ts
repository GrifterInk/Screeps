...
export class UpgraderAttributes implements RoleAttributes {
    ...
    //Tiny Upgrader: 2 WORK / 2 CARRY / 2 MOVE Total Cost: 400 Energy for 6 total parts
    Tiny = [
        WORK, WORK,
        CARRY, CARRY,
        MOVE, MOVE
    ...
    //Small Upgrader: 4 WORK / 4 CARRY / 2 MOVE Total Cost: 800 Energy for 12 total parts
    Small = [
        WORK, WORK, WORK, WORK,
    ...
    //Medium Upgrader: 6 WORK / 8 CARRY / 6 MOVE Total Cost: 1300 Energy for 20 total parts
    Medium = [
